...
?>
      <div class="col-lg-6 offset-md-3">
         <form id="medicinelist2" action="delete2.php" method="post">
                   <div class="col-lg-6 offset-md-3">
                ...
                <div class="col-lg-6 offset-md-3">
                 ...
                 <div class="col-lg-6 offset-md-3">
                  ...
                  <div class="col-lg-6 offset-md-3">
                   <input style="color:  #ff0000;width: 100px; margin-bottom: 40px;" type="submit" name="submit"  value="Delete" ><br><br>
