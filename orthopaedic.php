          ...
          <ul class="navbar-nav mr-auto nav">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <a class="dropdown-item js-scroll-trigger" href="#page-top">ORTHOPAEDIC ITEMS</a>
                </div>
       ...
       <div class="container">
         <div class="col-md-12">
		   ...
		   $conn = mysqli_connect("localhost", "root", "","medicinestore");
            $sql=("select `Pname`,`Company`,`Quantity`, `Price`,`Picture` from medicine where `Category`='Orthopaedic' ");
