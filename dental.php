            ...
            <li class="nav-item dropdown">
               <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <a class="dropdown-item js-scroll-trigger" href="#page-t">DENTAL & ORAL CARE</a>
       ...
       <div class="container">
         <div class="col-md-12">
		   ...
		   $conn = mysqli_connect("localhost", "root", "","medicinestore");
            $sql=("select `Pname`,`Company`,`Quantity`, `Price`,`Picture` from medicine where `Category`='Dental' ");
