...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="images/logo.png" class="logo" alt="Logo"></a>
      </div>

      <div class="col-lg-6 text-center">
     <form class="form-inline" action="Search.php" method="post">
          <input class="form-control mr-sm-2" type="search" placeholder="Search Product" autocomplete="off" name="search" style="width: 450px">
      ...
      <div class="col-lg-3 collapse navbar-collapse" id="navbarTogglerDemo02">
        <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
          <li class="nav-item active">
            <a class="nav-link js-scroll-trigger" href="#page-top"><img src="images/home.png" class="size2"></a>
          </li>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-dark">
          ...
          <ul class="navbar-nav mr-auto nav">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" id="demolist" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item" href="Health.php" value="Health" >HEALTH</a>
                  <a class="dropdown-item" href="babyfood.php" value="Babycare" >BABY CARE</a>
                  <a class="dropdown-item" href="orthopaedic.php" value="Orthopaedic" >ORTHOPAEDIC ITEMS</a>
                </div>
	 ...
	 <br><br>
		   ...
		   $conn = mysqli_connect("localhost", "root", "","medicinestore");
            $sql=("select `Pname`,`Company`,`Quantity`, `Price`,`Picture` from medicine ");
			 ...
			 ?>
                  ...
                  <form action="Cart.php" method="POST">
                    <div class="design">
                       ...
                       <input style="color:  #004d00;width:100px;" type="submit" value="Buy Now">
                    </div>
                  </form>
                </div>
